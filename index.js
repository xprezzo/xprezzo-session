...
var debug = require('xprezzo-debug')('xprezzo:session');
var deprecate = require('depd')('xprezzo-session');
...
module.exports.mixin = require('xprezzo-buffer').mixin;
module.exports.debug = require('xprezzo-debug');
module.exports.ms = require('xprezzo-debug').ms;
